...
(deftest notes-ingest-stamps-per-file-revisions
  (let [dir (str (fs/create-temp-dir {:prefix "claimgraph-evidence-notes"}))
        ev-dir (str (fs/create-temp-dir {:prefix "claimgraph-evidence-store"}))
        s (mem/create)
        _ (core/seed! s)]
