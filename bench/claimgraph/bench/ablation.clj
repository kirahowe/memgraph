(ns claimgraph.bench.ablation
  ...
  study): hold the fixture fixed, compare what each layer can answer —
    ...
    :claimgraph-full  the real read path (entity resolution, as-of, history,
    ...
    :claimgraph-fts   the graph's facts but reachable ONLY through full-text
...
(defn fts-results
  "The degraded-claimgraph arm: the graph's facts, but only what tokenized
